import { ACTION_IDENTITY, INIT_EVENT, COMMAND_RENDER } from "kingly"
...
const transitions = [
  ...
  // DOC: We cannot use just PIECE_SELECTED for black and white pieces, state names must be unique!
  // So we use WHITE_PIECE_SELECTED, and BLACK_PIECE_SELECTED
  {
    from: WHITE_PLAYS, event: BOARD_CLICKED, guards: [
      // DOC: guards should always cover the full space!! we don't do it here not to desviate from the drawing
  ...
  },
  {
    from: BLACK_PLAYS, event: BOARD_CLICKED, guards: [
      // DOC: guards should always cover the full space!! we don't do it here not to desviate from the drawing
      // TODO: here I will have to update the black and white pieces pos
